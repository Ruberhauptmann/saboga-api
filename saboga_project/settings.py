"""Django settings for saboga_project project.
...
SECRET_KEY = "django-insecure-5hoc#)jbh+d)q*gp3$l(*b@b8sbd#eqp52s#w%$znt2rm$st4!"
...
WSGI_APPLICATION = "saboga_project.wsgi.application"
