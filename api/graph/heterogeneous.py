...
This module is largely unchanged from the old SQLAlchemy based code; it
encapsulates a lightweight wrapper around a :class:`networkx.DiGraph` and
provides a handful of helpers for working with typed nodes and edges.
"""
